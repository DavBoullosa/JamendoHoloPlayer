...
package es.oneoctopus.jamendoholoplayer.services;
...
import es.oneoctopus.jamendoholoplayer.notifications.NowPlayingNotification;
...
public class PlayService extends Service implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener {
    public static final String TRACK_CHANGE = "es.oneoctopus.jamendoholoplayer.PlayService.action.TRACK_CHANGE";
    public static final String TRACK_START = "es.oneoctopus.jamendoholoplayer.PlayService.action.TRACK_START";
    public static final String TRACK_END = "es.oneoctopus.jamendoholoplayer.PlayService.action.TRACK_END";
    public static final String TRACK_BUFFERING = "es.oneoctopus.jamendoholoplayer.PlayService.action.TRACK_BUFFERING";
    public static final String PLAYLIST_LOADED = "es.oneoctopus.jamendoholoplayer.PlayService.action.PLAYLIST_LOADED";
    public static final String PLAYLIST_STARTED = "es.oneoctopus.jamendoholoplayer.PlayService.action.PLAYLIST_STARTED";
    public static final String PLAYLIST_END = "es.oneoctopus.jamendoholoplayer.PlayService.action.PLAYLIST_END";
